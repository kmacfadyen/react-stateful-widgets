...
export default function Input() {
  ...
  return (
    <div className='widget-input container'>
      ...
      <div>
        <input id='input' type='text' onChange={changeInput} value = {inputValue} /> {/* STEP 6 (Telling JS to keep track of that value,
          it will reset now when inputValue is reset*/}
